...
namespace Hermes
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSingleton<IUserActivity, UserActivityService>();
            services.AddScoped<IUserMessage, UserMessageService>();
        }
